...
%This function generates the interaction matrix based on normal
%distribution

%A_interaction - The adjacency matrix of the comunity
%S - Number of species
%mu - Mean of the normal distribution
%sigma - STD of the normal distribution
%pm - Probability for mutualistic interactions
%pc - Probability for competitive interactions
%pe - Probability for exploitative interactions
%pam - Probability for amensalistic interactions
%pcm - Probability for commensalistic interactions

%When pm=pc=pe=pam=pcm=0, this function generates a random interaction
%matrix
